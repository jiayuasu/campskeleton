 ...
 * meet in a single point: two or more of them are parallel or coincident, or a plane has NaN
 * coefficients. The skeleton machinery produces such configurations routinely for inputs with many
 ...
 * and the degenerate event is dropped instead.
 */
